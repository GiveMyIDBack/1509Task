...
public class Operator extends JFrame {
	...
	public Operator(Client current) {
		...
		*/
		...
		JLabel pSAI_L_ORIGIN = new JLabel("New label");
		...
		JLabel pSAI_L_DEST = new JLabel("New label");
		...
		*/
		...
		JButton cp_SEARCH = new JButton("New button");
		...
		JButton cp_ADDCLIENT = new JButton("New button");
		...
		JButton cp_SEARCHCLIENT = new JButton("New button");
