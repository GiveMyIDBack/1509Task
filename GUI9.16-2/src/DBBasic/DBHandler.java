...
public class DBHandler {
	    ...
	    */
	    ...
	    public String bookTicket(String cid,String aid,String seat_type,String seatid){
	    	...
	    	handler.ProcessSeat_seatt(aid, seat_type,seatid);
	    	return result;
	    }
	    public String cancelTicket(String CurrentOrderid){
	        ...
	        try {
	        	...
	        	sql = "select aid , seat_type , seat_id  from orders   "
	        	+"where orderid = ?  ";
	            ...
	            handler.GiveupSeat_airlinet(aid, seat_type);
	            handler.GiveupSeat_seatt(aid, seat_type, seat_id);
	 ...
	 public String getAircraft(String CurrentAid){
	    ...
	    public static void main(String[] args) {
	       ...
	       //myhandler.getAirline(20100908,"北京","上海");
	        myhandler.bookTicket("C00000001","TS103","FIRSTCLASS","1C");
	        //myhandler.cancelTicket("76B62CF0C92046F1935015FC8455BCB9");
